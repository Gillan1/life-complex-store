...
import { PrintingServices } from './printing-services'
...
export function ServicesView() {
  ...
  return (
    <div className="max-w-7xl mx-auto" dir={dir}>
      {/* ✅ قسم التصوير والطباعة - في الأعلى لأنه العمل الرئيسي */}
      ...
      >
        ...
        <p className="text-muted-foreground text-sm sm:text-base">
          {isAr
            ? 'خدمات إضافية يقدمها مجمع الحياة لعملائنا'
            : 'Additional services offered by Life Complex'}
        </p>
      </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
          ...
          >
            <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
              <div className="bg-gradient-to-br from-emerald-500 to-teal-600 p-5 text-white relative overflow-hidden">
                <div className="absolute top-0 end-0 w-24 h-24 bg-white/10 rounded-full -translate-y-6 translate-x-6" />
                <div className="absolute bottom-0 start-0 w-16 h-16 bg-white/10 rounded-full translate-y-4 -translate-x-4" />
                <div className="relative z-10 flex items-start gap-3">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-white/20 flex items-center justify-center flex-shrink-0 backdrop-blur-sm">
                    <Download className="h-6 w-6 sm:h-7 sm:w-7" />
                  </div>
                  <div className="min-w-0">
                    <h3 className="text-base sm:text-xl font-bold mb-1">{t('softwareDownloads')}</h3>
                    <p className="text-emerald-100 text-xs sm:text-sm leading-relaxed">{t('softwareDownloadsDesc')}</p>
                  </div>
                </div>
              </div>
              <CardContent className="p-4 sm:p-5 space-y-3">
                <div className="space-y-2">
                  <div className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30">
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 rounded-xl bg-gradient-to-r from-gray-50 to-slate-50 dark:from-gray-950/30 dark:to-slate-950/30">
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 rounded-xl bg-gradient-to-r from-slate-50 to-zinc-50 dark:from-slate-950/30 dark:to-zinc-950/30">
          ...
          >
            <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
              <div className="bg-gradient-to-br from-rose-500 to-red-600 p-5 text-white relative overflow-hidden">
                <div className="absolute top-0 end-0 w-24 h-24 bg-white/10 rounded-full -translate-y-6 translate-x-6" />
                <div className="absolute bottom-0 start-0 w-16 h-16 bg-white/10 rounded-full translate-y-4 -translate-x-4" />
                <div className="relative z-10 flex items-start gap-3">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-white/20 flex items-center justify-center flex-shrink-0 backdrop-blur-sm">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-base sm:text-xl font-bold mb-1">{t('moviesSeries')}</h3>
                    <p className="text-rose-100 text-xs sm:text-sm leading-relaxed">{t('moviesSeriesDesc')}</p>
                  </div>
                </div>
              </div>
              <CardContent className="p-4 sm:p-5 space-y-3">
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <div
                      key={genre.name}
                      className={`flex items-center gap-2 p-2 rounded-lg bg-gradient-to-r ${genre.color} transition-transform hover:scale-105 cursor-pointer`}
                    >
                      <div className="w-7 h-7 rounded-lg bg-white/60 dark:bg-white/10 flex items-center justify-center text-sm flex-shrink-0">
                        {genre.icon}
                      </div>
                      <div className="min-w-0">
                        <p className="font-semibold text-xs truncate">{genre.name}</p>
                        <p className="text-[10px] text-muted-foreground">{genre.items} {isAr ? 'عنوان' : 'titles'}</p>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          {/* ===== 3. Genshin Impact Game (Expanded Section) ===== */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Card className="border-0 shadow-lg overflow-hidden">
              <div
                className="bg-gradient-to-br from-violet-600 to-purple-700 p-5 sm:p-6 text-white relative overflow-hidden cursor-pointer"
                onClick={() => setGenshinExpanded(!genshinExpanded)}
              >
                ...
                <div className="relative z-10 flex items-center gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                      <h3 className="text-base sm:text-xl font-bold">{t('genshinImpact')}</h3>
                    ...
                    <p className="text-violet-100 text-xs sm:text-sm leading-relaxed mt-1">
                      {isAr
                  ...
                  <div className="flex-shrink-0">
                    {genshinExpanded ? (
                      <ChevronUp className="h-5 w-5 sm:h-6 sm:w-6 text-white/70" />
                    ) : (
                      ...
                      <div className="grid grid-cols-5 gap-1.5">
                        {genshinImages.slice(0, 10).map((img, i) => (
                          <div key={i} className="aspect-square rounded-lg overflow-hidden bg-muted/30">
                            <img src={asset(img.src)} alt="" className="w-full h-full object-cover" loading="lazy" />
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="sm:w-64 space-y-3">
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="text-center p-2.5 rounded-xl bg-violet-50 dark:bg-violet-950/30">
                          ...
                          <p className="text-[10px] text-muted-foreground">{isAr ? 'المنصة' : 'Platform'}</p>
                        ...
                        <div className="text-center p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/30">
                          ...
                          <p className="text-xs font-bold text-emerald-700 dark:text-emerald-300">{isAr ? 'مجانية' : 'Free'}</p>
                        </div>
                      </div>
          ...
          >
            <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
              <div className="bg-gradient-to-br from-amber-500 to-orange-600 p-5 text-white relative overflow-hidden">
                <div className="absolute top-0 end-0 w-24 h-24 bg-white/10 rounded-full -translate-y-6 translate-x-6" />
                <div className="absolute bottom-0 start-0 w-16 h-16 bg-white/10 rounded-full translate-y-4 -translate-x-4" />
                <div className="relative z-10 flex items-start gap-3">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-white/20 flex items-center justify-center flex-shrink-0 backdrop-blur-sm">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-base sm:text-xl font-bold mb-1">{t('firmwareService')}</h3>
                    <p className="text-amber-100 text-xs sm:text-sm leading-relaxed">{t('firmwareServiceDesc')}</p>
                  </div>
                </div>
              </div>
              <CardContent className="p-4 sm:p-5 space-y-3">
                <div className="space-y-2">
                  <div className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 rounded-xl bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-950/30 dark:to-yellow-950/30">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {isAr ? 'سامسونج، شاومي، هواوي، أوبو، فيفو وأكثر' : 'Samsung, Xiaomi, Huawei, OPPO, Vivo & more'}
                      </p>
                    </div>
                  </div>

                  <div className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 rounded-xl bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {isAr ? 'آيباد، تابلت سامسونج، تابلت شاومي وأكثر' : 'iPad, Samsung Tab, Xiaomi Pad & more'}
                      </p>
                    </div>
                  </div>

                  <div className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 rounded-xl bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-950/30 dark:to-amber-950/30">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {isAr ? 'ويندوز، تعريفات، برامج تشغيل وأكثر' : 'Windows, drivers, system software & more'}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {[
                    ...
                    isAr ? 'تعريفات' : 'Drivers',
                    isAr ? 'إصلاح أعطال' : 'Bug Fixes',
                    isAr ? 'استعادة البيانات' : 'Data Recovery',
                  ].map((feat) => (
          ...
          >
            <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
              <div className="bg-gradient-to-br from-cyan-500 to-blue-600 p-5 text-white relative overflow-hidden">
                <div className="absolute top-0 end-0 w-24 h-24 bg-white/10 rounded-full -translate-y-6 translate-x-6" />
                <div className="absolute bottom-0 start-0 w-16 h-16 bg-white/10 rounded-full translate-y-4 -translate-x-4" />
                <div className="relative z-10 flex items-start gap-3">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-white/20 flex items-center justify-center flex-shrink-0 backdrop-blur-sm">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-base sm:text-xl font-bold mb-1">{t('googleBypass')}</h3>
                    <p className="text-cyan-100 text-xs sm:text-sm leading-relaxed">{t('googleBypassDesc')}</p>
                  </div>
                </div>
              </div>
              <CardContent className="p-4 sm:p-5 space-y-3">
                <div className="p-3 sm:p-4 rounded-2xl bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-950/30 dark:to-blue-950/30">
                  ...
                  <div className="space-y-2">
                    {[
                      { step: '1', text: isAr ? 'إحضار الجهاز للمحل' : 'Bring device to store' },
                      { step: '2', text: isAr ? 'فحص الجهاز وتحديد المشكلة' : 'Diagnose the issue' },
                      { step: '3', text: isAr ? 'تخطي الحساب باحترافية' : 'Professional bypass' },
                      { step: '4', text: isAr ? 'استلام الجهاز جاهز للاستخدام' : 'Device ready to use' },
                    ].map((s) => (
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.5 }}
        className="mx-3 sm:mx-4 mt-4 mb-8 rounded-2xl overflow-hidden shadow-xl"
      >
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-5 text-white text-center">
          <h3 className="text-base sm:text-lg font-bold mb-1">
            {isAr ? 'كل هذه الخدمات متوفرة الآن في محل مجمع الحياة!' : 'All these services are now available at Life Complex!'}
          </h3>
          <p className="text-emerald-100 text-xs sm:text-sm mb-3">
            {isAr
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 hover:bg-white/30 text-white text-xs sm:text-sm font-medium transition-colors"
          >
            <MapPin className="h-4 w-4" />
            {isAr ? 'مجمع الحياة - دنقلا، السودان' : 'Life Complex - Dongola, Sudan'}
          </a>
        </div>
      </motion.div>
    </div>
